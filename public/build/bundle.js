...
var app = (function () {
    ...
    /* src/Link.svelte generated by Svelte v3.17.1 */
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "class", "svelte-dxkqw3");
    ...
    class Link extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*page*/ ctx[0] === undefined && !("page" in props)) {
    			console.warn("<Link> was created without expected prop 'page'");
    		}
    	}
    ...
    /* src/page/Home.svelte generated by Svelte v3.17.1 */
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			p = element("p");
    			t2 = text("It's been running for ");
    			t3 = text(/*seconds*/ ctx[0]);
    			t4 = text(" seconds");
    			attr_dev(h1, "class", "svelte-1nfgbb5");
    			add_location(h1, file$1, 37, 0, 511);
    			add_location(p, file$1, 38, 0, 538);
    			attr_dev(main, "class", "svelte-1nfgbb5");
    			add_location(main, file$1, 36, 0, 504);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*seconds*/ 1) set_data_dev(t3, /*seconds*/ ctx[0]);
    		},
    		i: noop,
    		o: noop,
    		d: function destroy(detaching) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const interval = setInterval(
    		() => {
    			$$invalidate(0, seconds = seconds + 1);
    		},
    		1000
    	);
    ...
    /* src/page/About.svelte generated by Svelte v3.17.1 */

    const file$2 = "src/page/About.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-1nfgbb5");
    			add_location(h1, file$2, 29, 0, 322);
    			attr_dev(main, "class", "svelte-1nfgbb5");
    			add_location(main, file$2, 28, 0, 315);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/Route.svelte generated by Svelte v3.17.1 */
    const file$3 = "src/Route.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$3, 14, 0, 318);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	const unsubscribe = curRoute.subscribe(value => {
    		$$invalidate(0, component = router.filter(r => r.path === $curRoute)[0].component);
    	});
